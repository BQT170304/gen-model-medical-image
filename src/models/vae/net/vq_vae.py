...
if __name__ == "__main__":
    ...
    def main(cfg: DictConfig):
        cfg["encoder"]["in_channels"] = 4
        cfg["encoder"]["z_channels"] = 4
        cfg["decoder"]["out_channels"] = 4
        cfg["decoder"]["z_channels"] = 4
        ...
        cfg["decoder"]["channel_multipliers"] = [1, 2, 4]
        cfg["decoder"]["n_attention_heads"] = None
        cfg["decoder"]["n_attention_layers"] = None
        cfg["vq_layer"]["embedding_dim"] = 4
        cfg["latent_dims"] = [4, 32, 32]
        print(cfg)
